function _HHC.Functions:createMainFrame()
    ...
    --backdrop color
    _LibWidgets:setBackdropColor(frame, _HHC.Colors["DEFAULT_FRAME_BACKDROP_COLOR"]);

    --backdrop border color
    _LibWidgets:setBackdropBorderColor(frame, _HHC.Colors["DEFAULT_FRAME_BACKDROP_BORDER_COLOR"]);

    --alpha
    _LibWidgets:setAlpha(frame, _HHC.Frames["DEFAULT_FRAME_ALPHA"]);
