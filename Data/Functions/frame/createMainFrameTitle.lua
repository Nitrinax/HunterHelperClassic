...
-- frame title
    ...
    _LibWidgets:setBackdropColor(frame, _HHC.Colors["DEFAULT_TITLE_FRAME_BACKDROP_COLOR"])
    _LibWidgets:setBackdropBorderColor(frame, _HHC.Colors["DEFAULT_TITLE_FRAME_BACKDROP_BORDER_COLOR"])

    --alpha
    _LibWidgets:setAlpha(frame, _HHC.Frames["DEFAULT_TITLE_FRAME_ALPHA"]);

    --title fontstring
    frame.text = _LibWidgets:createFontString(frame, nil, nil, _HHC.Fonts["DEFAULT_TITLE_FRAME_FONT"]);

    --anchors
    _LibWidgets:setPoint(frame.text, _HHC.Frames["DEFAULT_TITLE_FRAME_TEXT_POS"], _HHC.Frames["DEFAULT_TITLE_FRAME_TEXT_LEFT_OFFSET"], _HHC.Frames["DEFAULT_TITLE_FRAME_TEXT_TOP_OFFSET"])

    --title text
    _LibWidgets:setText(frame.text, _HHC.Data.ShortTitle);

    --alpha
    _LibWidgets:setAlpha(frame.text, _HHC.Frames["DEFAULT_TITLE_FRAME_COLUMN_ALPHA"]);
